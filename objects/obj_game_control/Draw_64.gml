...
if (room == rm_jogo)
{
	...
	draw_rectangle(0, _altura_gui - 80, _largura_gui, _altura_gui, false);
	draw_set_colour(c_white);
	draw_set_alpha(1);
	
	// Texto
	draw_set_halign(1);
	draw_text(_largura_gui / 2, _altura_gui - 70, $"Tempo sem CLT: {global.tempo_sem_clt} Segundos");
	draw_set_halign(-1);
	
	// Coletáveis
	draw_set_halign(1);
	draw_text(_largura_gui / 2, _altura_gui - 50, $"Comidas Coletadas: {global.coletados}");
	draw_set_halign(-1);
